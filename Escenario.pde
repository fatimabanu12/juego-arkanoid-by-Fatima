class Escenario {
  ...
  Escenario(int nivel) {
    ...
    colores[0] = color(#F72585); //MAGENTA
    colores[1] = color(#7209B7); //MORADO
    colores[2] = color(#3A0CA3); //MORADO- azul
    colores[3] = color(#4361EE); //AZUL CIELO
    colores[4] = color(#4CC9F0); //NUBE
  }
